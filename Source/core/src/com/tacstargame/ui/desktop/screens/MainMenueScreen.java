...
public class MainMenueScreen extends AbstractScreen {
	...
	public MainMenueScreen(TacStar tacStar) {
		...
		singleplayer = new UiColorLabel("Singleplayer", Color.CYAN, new Vector2(0,0));
		...
		editbox = new UiEditBox(new Vector2(400,800), new Measure(200,100));
		ui.addUiElement(editbox);
	}
